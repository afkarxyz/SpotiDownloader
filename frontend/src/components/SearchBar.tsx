    ...
    <div className="space-y-4">
      <div className="space-y-2">
        <div className="flex items-center">
          ...
          {/* Spacer to push token settings to the right */}
          <div className="flex-1" />

          {/* Token Settings - only show in URL mode, aligned with input field end (before Fetch button) */}
          {!searchMode && (
            <div className="flex items-center gap-3 mr-[65px]">
              <div className="flex items-center gap-2">
