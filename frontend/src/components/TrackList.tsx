...
import { Download, CheckCircle, XCircle, FileCheck, FileText, ImageDown } from "lucide-react";
                    ...
                    <div className="flex items-center justify-center gap-1">
                      {track.isrc && (<Tooltip>
                          <TooltipTrigger asChild>
                            <Button onClick={() => onDownloadTrack(track, folderName, isArtistDiscography, isAlbum, startIndex + index + 1)} size="sm" disabled={isDownloading || downloadingTrack === track.isrc}>
